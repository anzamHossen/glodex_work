                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div
                            ...
                            <h4 class="header-title mb-0">Add Applicant</h4>
                            <div class="d-flex">
                                <a href="{{ route('agent_applicant_list') }}" class="btn btn-sm btn-secondary me-2">
                        ...
                        <div class="card-body">
                            <form  action="{{ route('agent_save_new_applicant') }}" method="post" enctype="multipart/form-data">
                                @csrf
