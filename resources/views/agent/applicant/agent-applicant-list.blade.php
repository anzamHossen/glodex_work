                    ...
                    <div class="card">
                       <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex items-center gap-2">
                                <a href="{{ route('agent_applicant_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                                                ...
                                                <td>
                                                    <div class="dropdown position-relative">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="{{ route('agent_edit_applicant', $applicant->id) }}" class="dropdown-item d-flex align-items-center gap-1" title="Login As">
