                ...
                <div class="col-12">
                    <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column">
                        <div class="flex-grow-1">
                            <h4 class="fs-18 fw-semibold m-0">Home</h4>
                        </div>
                    </div><!-- end card header -->
                </div>
                <!--end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex admin-country-flag-img align-items-center justify-content-center ">
                                            <img src="{{ $country->flag && file_exists(public_path($country->flag)) ? asset($country->flag) : asset('back-end/assets/images/dr-profile/image-upload.jpg') }}" alt="Country" class="img-fluid">
                                        </div>
