                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div
                            ...
                            <div class="d-flex">
                                <a href="{{ route('agent_university_list') }}" class="btn btn-sm btn-gradient">
                                        ...
                                        <div class="row pb-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="info-card">
                                                    ...
                                                    <div class="info-value">
                                                        <i
                                                            class="bi bi-pin-map"></i>{{ $universityDetails->address ?? 'Not Added' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="info-card">
                                                    ...
                                                    <div class="info-value">
                                                        {{ $universityDetails->commission_for_agent ?? 'Not Added' }}</div>
                                                </div>
                                            </div>
                                        </div>
