@extends('layouts.app')
@section('title', '| Agent Applicant List')
@section('content')
    <!-- Begin page -->
    <div class="wrapper">
                ...
                <div class="col-xl-12">
                    <div class="card">
                       <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                            <h4 class="header-title mb-0">Agent Applicant</h4>
                            <div class="d-flex items-center gap-2">
                                ...
                                @endcan
                                <a href="{{ route('applicant_list_agent') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
