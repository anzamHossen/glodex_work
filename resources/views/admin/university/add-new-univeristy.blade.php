                            ...
                            <form id="universityForm" action="{{ route('save_new_university') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="commission" name="commission_for_us" value="{{ old('commission_for_us') }}" placeholder="Enter commision" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="commission" name="commission_for_agent" value="{{ old('commission_for_agent') }}" placeholder="Enter commision" required>
