                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div
                            ...
                            <h4 class="header-title mb-0">Application For Existing Record</h4>
                            <div class="d-flex">
                        ...
                        <div class="card-body">
                            <form  action="{{ route('save_student_application_exit_record') }}" method="post" enctype="multipart/form-data">
                                @csrf
