                ...
                <div class="col-xl-12">
                    <div class="card">
                       <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                            <h4 class="header-title mb-0">Record List</h4>
                            <div class="d-flex items-center gap-2">
                                <a href="{{ route('my_record_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                                                ...
                                                <td>
                                                    <div class="dropdown position-relative">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a href="{{ route('edit_my_record', $student->id) }}" class="dropdown-item d-flex align-items-center gap-1" title="Login As">
