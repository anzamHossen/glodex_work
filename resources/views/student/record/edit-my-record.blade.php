            ...
            <div class="row mt-2">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form  action="{{ route('update_my_record', $student->id ?? null) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    @if($student && $student->studentfiles->count())
                                        @foreach($student->studentfiles as $single)
                                            <div class="col-md-3 mt-2 mb-6">
                                                <label class="form-label" style="color: #FF6D43">
                                                    {{ $single->filename }} <span class="text-danger">*</span>:
                                                </label>

                                                <input type="hidden" value="{{ $single->filename }}" name="filename[]" />
