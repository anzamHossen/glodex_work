                ...
                <div class="card">
                    <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex items-center gap-1">
                            <a href="{{ route('student_course_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                <div class="glodex-show-entries d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    ...
                                    <form method="GET" action="{{ route('student_search_course') }}" class="d-flex align-items-center gap-2">
                                    ...
                                    <!-- Search form -->
                                    <form action="{{ route('student_search_course') }}" method="GET" class="d-flex align-items-center align-items-end">
                                    ...
                                    <div class="course-list-card border position-relative">
                                        ...
                                        <div class="btn-group glodex-custom-3dot-dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="{{ route('student_course_details', $course->id) }}"><i class="ti ti-map-pin me-2"></i> CourseDetails</a></li>
                                            </ul>
                                        </div>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="course_filterBtn" aria-labelledby="offcanvasRightLabel">
  ...
  <div class="offcanvas-body">
    <form action="{{ route('student_filter_course') }}" method="GET">
        <div class="mb-3">
