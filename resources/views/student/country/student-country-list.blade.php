                    ...
                    <div class="card">
                        <div class="card-header border-bottom border-dashed d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex items-center gap-2">
                                <a href="{{ route('student_country_list') }}" class="btn btn-sm glodex-blue-btn" id="addNewCountryBtn">
                                ...
                                <div class="col-12 mb-3">
                                    <div class="glodex-show-entries d-flex align-items-center justify-content-between flex-wrap gap-3">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <form method="GET" action="{{ route('search_student_countries') }}">
                                                <div class="d-flex align-items-center gap-2">
                                        ...
                                        <!-- Search form -->
                                        <form action="{{ route('search_student_countries') }}"  method="GET" class="d-flex align-items-center align-items-end">
                                        ...
                                        <div class="glodex-country-list-item position-relative h-100 border rounded-4 shadow-sm p-2">
                                            <div class="btn-group glodex-custom-3dot-dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('search_student_university', ['country_id' => $country->id]) }}" target="_blank"><i class="ti ti-school me-2"></i>Universities</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('student_filter_course', ['country_id' => $country->id]) }}" target="_blank">
                                                            <i class="ti ti-book-2 me-2"></i> Courses
                                                        </a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="{{ route('student_country_details', $country->id) }}"><i class="ti ti-map-pin me-2"></i> Country Details</a></li>
                                                </ul>
                                            </div>
