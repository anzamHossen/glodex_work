                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                            ...
                                            <h3 class="mb-0 fw-bold">{{ $totalActiveAgent ?? 0 }}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                            ...
                                            <h3 class="mb-0 fw-bold">{{ $totalApplications ?? 0}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                            ...
                                            <h3 class="mb-0 fw-bold">{{ $totalVisaGranted ?? 0}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center gap-2 my-2 py-1">
                                            ...
                                            <h3 class="mb-0 fw-bold">{{ $totalVisaRejected ?? 0}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div><!-- end col -->
